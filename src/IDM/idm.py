...
def time_to_collision(
    ...
    """
    relative_position = np.array((position1.x, position1.y)) - np.array((position2.x, position2.y))
    relative_velocity = np.array((velocity1.x, velocity1.y)) - np.array((velocity2.x, velocity2.y))
